...
insert into student(stu_id, name, age, birthday) 
values(100,'홍길동',22,'1998/03/03');

select * from student;

select regDate - birthday from student;
select (regDate - birthday)/365 from student;
select round((regDate - birthday)/365) from student;
